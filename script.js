// -- zonelets code //
/*
  the following code and comments were not made by me (lily), see zonelets.net for more information.
*/
...
let postsArray = [
//[ "posts/2020-11-10-Special-Characters-Example.html", "0kB", encodeURI( 'Spéci@l "Character\'s" Examp|e' ) ],
[ "posts/2020-12-28-toki-pona-tools.html" ] ];
...
let authorLink = relativePath + '/about';
...
'<li><a href="' + relativePath + '/info.html">About</a></li> </ul>';
...
function formatPostLink(i) {
  ...
  let sizewarning = ''
  //if (postsArray[i].length>1) sizewarning = ' <span class="linksize">(' + postsArray[i][1] + ')'
  if (  postDateFormat.test ( postsArray[i][0].slice( 6,17 ) ) ) {
    return '<li><a href="' + relativePath + '/'+ postsArray[i][0] +'">' + postsArray[i][0].slice(6,16) + " \u00BB " + postTitle_i + '</a>' + sizewarning + '</li>';
  } else {
    return '<li><a href="' + relativePath + '/'+ postsArray[i][0] +'">' + postTitle_i + sizewarning + '</span></a></li>';
  }
}
...
if ( postsArray.length < 2 ) {
  nextprevHTML = '<a href="' + relativePath + '/home.html">Home</a>';
} else if ( currentIndex === 0 ) {
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a href="' + relativePath + '/home.html">Home</a> | <a href="'+ relativePath + '/' + prevlink +'">Previous Post \u00BB</a>';
} else if ( currentIndex === postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  nextprevHTML = '<a href="' + relativePath + '/' + nextlink +'">\u00AB Next Post</a> | <a href="' + relativePath + '/home.html">Home</a>';
} else if ( 0 < currentIndex && currentIndex < postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a href="' + relativePath + '/'+ nextlink +'">\u00AB Next Post</a> | <a href="' + relativePath + '/home.html">Home</a> | <a href="' + relativePath + '/'+ prevlink +'">Previous Post \u00BB</a>';
}
